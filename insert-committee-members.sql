...
('Abaleng Magano', 'Female', 'committee', 'Secretary', 'Executive Committee', 4),
...
-- Youth Committee
INSERT INTO choir_members (name, gender, category, role, committee_name, display_order) VALUES
('Thusego Wamakhubu', 'Male', 'committee', 'Chairperson', 'Youth Committee', 10),
('Kabontle Kgautlhe', 'Female', 'committee', 'Deputy Chair', 'Youth Committee', 11),
...
('Boago Okgetheng', 'Male', 'committee', 'Member', 'Fundraising Committee', 23),
